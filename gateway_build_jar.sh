...
# Build JAR for Gateway service only (replace with your project directory and name)
build_jar ../gatewayservice gateway

echo "JAR file built for Gateway service!"
